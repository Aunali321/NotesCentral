...
if (isset($_REQUEST['username'], $_REQUEST['email'], $_REQUEST['password'])) {
    ...
    if ($result) {
        ...
        <div id="dropdown-cta" class="p-4 mt-6 mx-3 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
         <div class="flex items-center mb-3">
            <span class="bg-orange-100 text-orange-800 text-sm font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-orange-200 dark:text-orange-900">Success</span>
  ...
  <div class="ml-3 text-sm font-medium">
    Required fields are missing. <a href="#" class="font-semibold underline hover:no-underline">Click here to </a> register again.
  </div>
...
<body>
    ...
    <div class="flex items-center justify-center h-screen">
        <div class="max-w-sm p-12 bg-white border border-gray-200 rounded-lg shadow md:p-20 md:max-w-3xl dark:bg-gray-800 dark:border-gray-700">
            <form class="space-y-8 md:p-6 md:m-2" action="#" method="POST">
                <h5 class="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-white text-center">Sign up for <span class="bg-gradient-to-r from-cyan-500 to-blue-500 text-transparent bg-clip-text font-bold">NotesCentral</span></h5>
                <div>
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="id@maktabahjafariyah.org" required>
                </div>
                <div>
